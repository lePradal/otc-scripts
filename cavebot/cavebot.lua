...
local caveBotIcon = addIcon("caveBotIcon", {text="Cave Bot", item = {id = ICON_ITEM_ID, count = 1}, moveable=true}, function(icon, isOn)
    if isOn then
        CaveBot.setOn()
    else
        CaveBot.setOff()
...
caveBotIcon:setSize({height=50,width=250})
caveBotIcon:breakAnchors()
caveBotIcon:move(80, 230)